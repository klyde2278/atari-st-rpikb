...
/*
 * USB HID (EN_UK) -> Atari ST IKBD scancode lookup (128 entries).
 * Generic mappings included:
 ...
 * - USB HID usage codes: PrintScreen=0x46, ScrollLock=0x47, PageUp=0x4B, PageDown=0x4E.
 */
...
extern "C" {
const uint8_t st_key_lookup_hid_en_uk[ST_KEY_LOOKUP_SIZE] = {
