...
const uint8_t st_key_lookup_hid_fr_fr[ST_KEY_LOOKUP_SIZE] = {
    ...
    12,  // 0x2d  Keyboard - and _ redirected to ! and §
    53,  // 0x2e  Keyboard = and + redirected to = and +
    ...
    43,  // 0x35  Keyboard ` and ~ redirected to ²
    51,  // 0x36  Keyboard , and <
    52,  // 0x37  Keyboard . and >
    13,  // 0x38  Keyboard / and ?
    ...
    0,   // 0x44  Keyboard F11
    0,   // 0x45  Keyboard F12
    98,  // 0x46  Keyboard Print Screen redirected to Help
    97,  // 0x47  Keyboard Scroll Lock redirected to Undo
    0,   // 0x48  Keyboard Pause
    82,  // 0x49  Keyboard Insert
    71,  // 0x4a  Keyboard Home
    99,  // 0x4b  Keyboard Page Up redirected to Keypad (
    83,  // 0x4c  Keyboard Delete Forward
    0,   // 0x4d  Keyboard End
    100, // 0x4e  Keyboard Page Down redirected to Keypad )
